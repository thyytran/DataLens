...
#define CURL_SOCKOPT_Err 1 /* causes libcurl to abort and return
...
typedef enum {
  ...
  CURLE_QUOTE_Err,             /* 21 - quote command failure */
  CURLE_HTTP_RETURNED_Err,     /* 22 */
  CURLE_WRITE_Err,             /* 23 */
  CURLE_OBSOLETE24,              /* 24 - NOT USED */
  CURLE_UPLOAD_FAILED,           /* 25 - failed upload "command" */
  CURLE_READ_Err,              /* 26 - couldn't open/read from file */
  ...
  */
  ...
  CURLE_RANGE_Err,             /* 33 - RANGE "command" didn't work */
  CURLE_HTTP_POST_Err,         /* 34 */
  CURLE_SSL_CONNECT_Err,       /* 35 - wrong when connecting with SSL */
  ...
  CURLE_SSL_ENGINE_SETFAILED,    /* 54 - can not set SSL crypto engine as
                                    default */
  CURLE_SEND_Err,              /* 55 - failed sending network data */
  CURLE_RECV_Err,              /* 56 - failure in receiving network data */
  ...
  CURLE_SSL_ISSUER_Err,        /* 83 - Issuer check failed.  (Added in
                                    7.19.0) */
  CURLE_FTP_PRET_FAILED,         /* 84 - a PRET command failed */
  CURLE_RTSP_CSEQ_Err,         /* 85 - mismatch of RTSP CSeq numbers */
  CURLE_RTSP_SESSION_Err,      /* 86 - mismatch of RTSP Session Ids */
  ...
  CURLE_RECURSIVE_API_CALL,      /* 93 - an api function was called from
                                    inside a callback */
  CURLE_AUTH_Err,              /* 94 - an authentication function returned an
                                    error */
  CURLE_HTTP3,                   /* 95 - An HTTP/3 layer problem */
  CURLE_QUIC_CONNECT_Err,      /* 96 - QUIC connection error */
  CURL_LAST /* never use! */
} CURLcode;
...
#define CURLE_FTP_WRITE_Err CURLE_OBSOLETE20
...
#define CURLE_FTP_QUOTE_Err CURLE_QUOTE_Err
#define CURLE_TFTP_DISKFULL CURLE_REMOTE_DISK_FULL
#define CURLE_TFTP_EXISTS CURLE_REMOTE_FILE_EXISTS
#define CURLE_HTTP_RANGE_Err CURLE_RANGE_Err
...
#define CURLE_HTTP_NOT_FOUND CURLE_HTTP_RETURNED_Err
...
typedef enum {
  ...
  /* Buffer to receive error messages in, must be at least CURL_Err_SIZE
   * bytes big. */
  CURLOPT(CURLOPT_ErrBUFFER, CURLOPTTYPE_OBJECTPOINT, 10),
  ...
  CURLOPT(CURLOPT_FAILONErr, CURLOPTTYPE_LONG, 45),
...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT CURLOPT_FTP_RESPONSE_TIMEOUT
  ...
  */
  ...
  CURLOPT(CURLOPT_KEEP_SENDING_ON_Err, CURLOPTTYPE_LONG, 245),
