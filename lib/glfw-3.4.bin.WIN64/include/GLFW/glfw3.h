 ...
 */
#define GLFW_PLATFORM_Err         0x00010008
 ...
 *
 *  Context error suppression [hint](@ref GLFW_CONTEXT_NO_Err_hint) and
 *  [attribute](@ref GLFW_CONTEXT_NO_Err_attrib).
 */
#define GLFW_CONTEXT_NO_Err       0x0002200A
 ...
 *
 *  @errors Possible errors include @ref GLFW_PLATFORM_Err.
 *
 ...
 *  call, it returns @ref GLFW_NO_Err (zero) and the description pointer is
 *  set to `NULL`.
 *
 *  @param[in] description Where to store the error description pointer, or `NULL`.
 *  @return The last error code for the calling thread, or @ref GLFW_NO_Err
 *  (zero).
 *
 *  @errors None.
 *
 ...
 *  @ref GLFW_PLATFORM_Err and @ref GLFW_FEATURE_UNAVAILABLE (see remarks).
 *
 ...
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref GLFW_PLATFORM_Err
 ...
 *  GLFW_NO_WINDOW_CONTEXT and @ref GLFW_PLATFORM_Err.
 *
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_INVALID_VALUE, @ref GLFW_PLATFORM_Err and @ref
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_PLATFORM_Err and @ref GLFW_FEATURE_UNAVAILABLE (see remarks).
 *
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_INVALID_VALUE and @ref GLFW_PLATFORM_Err.
 *
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_INVALID_ENUM and @ref GLFW_PLATFORM_Err.
 *
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_INVALID_ENUM, @ref GLFW_INVALID_VALUE, @ref GLFW_PLATFORM_Err and @ref
 *  GLFW_FEATURE_UNAVAILABLE (see remarks).
 *
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_INVALID_ENUM, @ref GLFW_PLATFORM_Err and @ref
 ...
 *  a system that does not support it, @ref GLFW_PLATFORM_Err will be emitted.
 *
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_INVALID_VALUE, @ref GLFW_INVALID_ENUM and @ref GLFW_PLATFORM_Err.
 *
 ...
 *  cannot acquire the lock then this function emits @ref GLFW_PLATFORM_Err and returns.
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_FORMAT_UNAVAILABLE and @ref GLFW_PLATFORM_Err.
 *
 *  @remark @win32 The clipboard on Windows has a single global lock for reading and
 *  writing.  GLFW tries to acquire it a few times, which is almost always enough.  If it
 *  cannot acquire the lock then this function emits @ref GLFW_PLATFORM_Err and returns.
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_NO_CURRENT_CONTEXT and @ref GLFW_PLATFORM_Err.
 *
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_API_UNAVAILABLE and @ref GLFW_PLATFORM_Err.
 *
 ...
 *  this function returns `VK_Err_INITIALIZATION_FAILED` and generates a @ref
 *  GLFW_API_UNAVAILABLE error.  Call @ref glfwVulkanSupported to check whether
 *  Vulkan is at least minimally available.
 *
 *  If the required window surface creation instance extensions are not
 *  available or if the specified instance was not created with these extensions
 *  enabled, this function returns `VK_Err_EXTENSION_NOT_PRESENT` and
 ...
 *  and returns `VK_Err_NATIVE_WINDOW_IN_USE_KHR`.
 *
 ...
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 *  GLFW_API_UNAVAILABLE, @ref GLFW_PLATFORM_Err and @ref GLFW_INVALID_VALUE
 *
