...
void    ImGui::EndTabBar()
{
    ...
    if (tab_bar == NULL)
    {
        IM_ASSERT_USER_Err(tab_bar != NULL, "Mismatched BeginTabBar()/EndTabBar()!");
        return;
    }
...
bool    ImGui::BeginTabItem(const char* label, bool* p_open, ImGuiTabItemFlags flags)
{
    ...
    if (tab_bar == NULL)
    {
        IM_ASSERT_USER_Err(tab_bar, "Needs to be called between BeginTabBar() and EndTabBar()!");
        return false;
    }
...
void    ImGui::EndTabItem()
{
    ...
    if (tab_bar == NULL)
    {
        IM_ASSERT_USER_Err(tab_bar != NULL, "Needs to be called between BeginTabBar() and EndTabBar()!");
        return;
    }
